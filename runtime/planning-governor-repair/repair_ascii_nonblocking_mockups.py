...
def leeway_try_image_endpoints(prompt: str):
    ...
    svg_parts = [
        ...
        f'<text x="80" y="270" fill="#f4f8ff" font-size="72" font-family="Segoe UI, Arial" font-weight="900">{title}</text>',
        f'<text x="84" y="322" fill="#aebcd0" font-size="28" font-family="Segoe UI, Arial">{subtitle}</text>',
        ...
        f'<text x="112" y="458" fill="#f4f8ff" font-size="30" font-family="Segoe UI, Arial" font-weight="800">{cards[0]}</text>',
        f'<text x="382" y="458" fill="#f4f8ff" font-size="30" font-family="Segoe UI, Arial" font-weight="800">{cards[1]}</text>',
        f'<text x="652" y="458" fill="#f4f8ff" font-size="30" font-family="Segoe UI, Arial" font-weight="800">{cards[2]}</text>',
        f'<text x="922" y="458" fill="#f4f8ff" font-size="30" font-family="Segoe UI, Arial" font-weight="800">{cards[3]}</text>',
...
src = re.sub(pattern, new_block, src, count=1)
