import AgentLeeDeviceLayerMasterStatusPanel from '@/components/AgentLeeDeviceLayerMasterStatusPanel';

export const dynamic = 'force-dynamic';

export default function DeviceLayerMasterStatusPage() {
  return (
    <>
      <AgentLeeDeviceLayerMasterStatusPanel />
