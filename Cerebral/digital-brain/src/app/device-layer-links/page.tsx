import AgentLeeDeviceLayerLinksPanel from '@/components/AgentLeeDeviceLayerLinksPanel';

export const dynamic = 'force-dynamic';

export default function DeviceLayerLinksPage() {
  return (
    <>
      <AgentLeeDeviceLayerLinksPanel />
