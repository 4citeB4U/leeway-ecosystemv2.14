...
const payload = {
  ok: true,
  name: "Device Continuity Risk Matrix Rules",
  route: "/api/device-continuity-risk-matrix/rules",
  purpose: "Return locked global safety rules from 389.",
  locked: true,
  contractOnly: true,
  noExecute: true,
  ...
  data: {"rules":8,"criticalRequiresOwnerUnlock":true,"receiptsRequired":true}
};
