...
const payload = {
  ok: true,
  name: "Device Continuity Risk Matrix Summary",
  route: "/api/device-continuity-risk-matrix/summary",
  purpose: "Return risk count summary from 389.",
  locked: true,
  contractOnly: true,
  noExecute: true,
  ...
  data: {"total":14,"critical":5,"high":8,"medium":1,"low":0}
};
