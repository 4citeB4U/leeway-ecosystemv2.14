...
const payload = {
  ok: true,
  name: "SmartThings Locked Stub Summary",
  route: "/api/smartthings-locked-stub/summary",
  purpose: "Return locked SmartThings physical authority summary.",
  locked: true,
  contractOnly: true,
  noExecute: true,
  ...
  data: {"physicalActionAuthorized":false,"smartHomeControlBlocked":true}
};
