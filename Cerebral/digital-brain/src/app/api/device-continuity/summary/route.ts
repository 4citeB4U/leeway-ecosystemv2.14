...
const payload = {
  ok: true,
  name: "Device Continuity Summary",
  route: "/api/device-continuity/summary",
  purpose: "Return locked Device Continuity summary from contracts 388, 389, and 390.",
  locked: true,
  contractOnly: true,
  noExecute: true,
  ...
  data: {"riskCounts":{"total":14,"critical":5,"high":8,"medium":1,"low":0},"families":14}
};
