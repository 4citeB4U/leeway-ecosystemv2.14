...
- Generated: 2026-05-06T21:56:25.9960113-05:00
...
- [FAIL] No runtime dependency on external LeeWay-Standards remains C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Convert-AgentLeeToStandalone.ps1:6:PURPOSE: Safely archives, verifies, and optionally deletes the external LeeWay-Standards folder after standalone migration.; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Convert-AgentLeeToStandalone.ps1:18:$externalRoot = Join-Path $WorkspaceRoot "LeeWay-Standards"; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Convert-AgentLeeToStandalone.ps1:21:$backupPath = Join-Path $archiveRoot "LeeWay-Standards-pre-standalone-$timestamp"; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Convert-AgentLeeToStandalone.ps1:79:$remainingExternalRefs = @(& rg -n "LeeWay-Standards|\.leeway-vscode\\LeeWay-Standards|\.leeway-vscode/LeeWay-Standards" $agentLeeRoot 2>$null); C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Convert-AgentLeeToStandalone.ps1:89:  $deleteReason = "Runtime or repo references to external LeeWay-Standards still remain."; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Invoke-AgentLeeDoctor.ps1:469:    $hits = & rg -n "LeeWay-Standards|\.leeway-vscode\\LeeWay-Standards|\.leeway-vscode/LeeWay-Standards" $target 2>$null; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Invoke-AgentLeeDoctor.ps1:473:    if ($content -match "LeeWay-Standards|\.leeway-vscode\\LeeWay-Standards|\.leeway-vscode/LeeWay-Standards") {; C:\Users\Leona\.leeway-vscode\agent-lee\scripts\Invoke-AgentLeeDoctor.ps1:478:$checks.Add((New-Check "No runtime dependency on external LeeWay-Standards remains" ($externalPathHits.Count -eq 0) (($externalPathHits -join "; "))))
