...
- Generated: 2026-05-14T05:35:03.5727727-05:00
...
- Failed checks: 1
- LeeWay compliance: 95.81%
- LeeWay blocking file count: 7
...
- [PASS] extension.ts contains AGENT_LEE_UI_VERSION C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.ts
...
- [PASS] VSIX package builds C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\agent-lee-leeway-coding-system-1.2.3.vsix
- [PASS] VSIX file exists C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\agent-lee-leeway-coding-system-1.2.3.vsix
- [PASS] VSIX file count is below 700 Count: 369
...
- [PASS] LeeWay aggregate compliance reported Score: 95.81
- [FAIL] LeeWay blocking file count is zero Blocking files: 7

## Compliance

Inspected 334 files; 320 are fully marked with header, region, tag, and discovery pipeline.
Aggregate compliance percentage: 95.81%
Blocking files: 7

## Blocking Compliance Files
- .\agent-lee\receipts\leeway_application_integrity_gate_2026-05-14_052723.md: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\lavr-host-router-dynamic-result.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\lavr-playback-gate-dynamic-result.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\leeway-application-integrity-command-audit.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\leeway-application-integrity-result.json: missing LEEWAY_HEADER, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\leeway-application-integrity-vsix-scan.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\test-evidence\runtime-smoke-voice-provider-result.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE

## Blocking Items
- LeeWay blocking file count is zero: Blocking files: 7
