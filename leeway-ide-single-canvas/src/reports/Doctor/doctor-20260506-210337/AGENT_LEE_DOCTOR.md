...
- Generated: 2026-05-06T21:03:45.6060627-05:00
...
- [PASS] LeeWay compliance above 70 Score: 76.1

## Compliance

Inspected 205 files; 156 are fully marked with header, region, tag, and discovery pipeline.
Blocking files: 49
...
- .\agent-lee\vscode-extension\src\core\LLMProvider.ts: missing DISCOVERY_PIPELINE
...
- .\agent-lee\vscode-extension\src\tools\image-tool.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\src\tools\logger.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\src\tools\permissions.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\src\tools\router.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\src\tools\web-search.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
