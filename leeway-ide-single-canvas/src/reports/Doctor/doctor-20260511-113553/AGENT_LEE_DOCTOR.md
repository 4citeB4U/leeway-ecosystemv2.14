...
- Generated: 2026-05-11T11:36:06.1475283-05:00
- Extension: `C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension`
- VSIX: `C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\agent-lee-leeway-coding-system-1.2.2.vsix`
- Failed checks: 7
- LeeWay compliance: 88.98%
- LeeWay blocking file count: 32
...
- [FAIL] main points to dist/extension.js ./out/extension.js
...
- [FAIL] Activation event declared: onStartupFinished 
- [FAIL] Activation event declared: onView:agentLee.sidebar 
...
- [PASS] VSIX package builds C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\agent-lee-leeway-coding-system-1.2.2.vsix
- [PASS] VSIX file exists C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\agent-lee-leeway-coding-system-1.2.2.vsix
- [PASS] VSIX file count is below 700 Count: 370
...
- [FAIL] extension.ts routes Agent Lee controlled prompts and summaries through approved wrappers 4 direct notification call(s)
...
- [FAIL] No runtime dependency on external LeeWay-Standards remains C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.backup-rightpanel-20260511-092038.ts:2228:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-activitybar.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.backup-rightpanel-20260511-092038.ts:2231:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-button.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.broken-20260511-085621.ts:2228:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-activitybar.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.broken-20260511-085621.ts:2231:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-button.svg")
- [PASS] LeeWay aggregate compliance reported Score: 88.98
- [FAIL] LeeWay blocking file count is zero Blocking files: 32

## Compliance

Inspected 372 files; 331 are fully marked with header, region, tag, and discovery pipeline.
Aggregate compliance percentage: 88.98%
Blocking files: 32

## Blocking Compliance Files
- .vscode\extensions.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\AUTO_UPDATE_FIX_SUMMARY.md: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\AUTO_UPDATE_IMPLEMENTATION_COMPLETE.md: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\Agent_Lee_Persona_System\00_README.md: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\.vscode\settings.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\README.md: missing REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\Run-All.ps1: missing REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\package-lock.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\package.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-settings-snippet.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\.vscode\settings.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\README.md: missing REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\Run-All.ps1: missing REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\package-lock.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\package.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\mcp\adapters\vscode-mcp-tooling\vscode-mcp-settings-snippet.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\leeway-sdk\package.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\leeway-sdk\tsconfig.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\leeway-config.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\mcp\agent-registry.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\mcp\agent-test-spec.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\mcp\context-packet.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\mcp\mission-summary.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\mcp\validation-result.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\leeway-config.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\mcp\agent-registry.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\mcp\agent-test-spec.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\mcp\context-packet.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\mcp\mission-summary.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\sdk\schemas\schemas\mcp\validation-result.schema.json: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\receipts\logo_fix_receipt.md: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE
- .\agent-lee\vscode-extension\src\types\jsdom.d.ts: missing LEEWAY_HEADER, REGION, TAG, DISCOVERY_PIPELINE

## Blocking Items
- main points to dist/extension.js: ./out/extension.js
- Activation event declared: onStartupFinished: 
- Activation event declared: onView:agentLee.sidebar: 
- extension.ts contains AGENT_LEE_UI_VERSION: C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.ts
- extension.ts routes Agent Lee controlled prompts and summaries through approved wrappers: 4 direct notification call(s)
- No runtime dependency on external LeeWay-Standards remains: C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.backup-rightpanel-20260511-092038.ts:2228:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-activitybar.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.backup-rightpanel-20260511-092038.ts:2231:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-button.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.broken-20260511-085621.ts:2228:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-activitybar.svg"); C:\Users\Leona\.leeway-vscode\agent-lee\vscode-extension\src\extension.broken-20260511-085621.ts:2231:    vscode.Uri.joinPath(context.extensionUri, "media", "leeway-standards-button.svg")
- LeeWay blocking file count is zero: Blocking files: 32
