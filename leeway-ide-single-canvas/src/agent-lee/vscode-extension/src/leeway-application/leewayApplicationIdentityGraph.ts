...
export const LEEWAY_APPLICATION_IDENTITY_GRAPH_VERSION = "2026-05-26.release-state-sanitization-pass-1";
...
export const LEEWAY_APPLICATION_COMMAND_AUTHORITY = {
  voiceReviewClarify: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_REVIEW_CLARIFY",
    owner: "AGENT_LEE",
    source: "WEBVIEW_TO_HOST",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  voiceReviewCreateProposal: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_REVIEW_CREATE_PROPOSAL",
    owner: "AGENT_LEE",
    source: "WEBVIEW_TO_HOST",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  voiceReviewDiscard: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_REVIEW_DISCARD",
    owner: "AGENT_LEE",
    source: "WEBVIEW_TO_HOST",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  voiceReviewSend: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_REVIEW_SEND",
    owner: "AGENT_LEE",
    source: "WEBVIEW_TO_HOST",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  submitVoiceReviewMessage: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_REVIEW_SUBMIT_MESSAGE",
    owner: "AGENT_LEE",
    source: "HOST_TO_WEBVIEW",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  actionDisclosureRejected: {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::ACTION_DISCLOSURE_REJECTED",
    owner: "AGENT_LEE",
    source: "HOST_TO_WEBVIEW",
    governanceNode: "LEEWAY_APP::HOST::COMMAND_ROUTER::HOST_TO_WEBVIEW"
  },
  "agentLee.voiceBridge.handleRuntimeStatus": {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_BRIDGE_RUNTIME_STATUS",
    owner: "AGENT_LEE",
    source: "VSCODE_COMMAND",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  },
  "agentLee.voiceBridge.handleTranscript": {
    subjectObjectId: "LEEWAY_OBJECT::COMMAND::VOICE_BRIDGE_TRANSCRIPT",
    owner: "AGENT_LEE",
    source: "VSCODE_COMMAND",
    governanceNode: "LEEWAY_APP::VOICE::LAVR::TRANSCRIPT_BRIDGE"
  }
...
export const LEEWAY_APPLICATION_REQUIRED_NODE_IDS = [
  ...
  "LEEWAY_APP::PACKAGE::RUNTIME_SEED::UPDATE_REGISTRY",
  "LEEWAY_APP::PACKAGE::RELEASE::STATE_SANITIZER",
...
export const LEEWAY_APPLICATION_IDENTITY_GRAPH: LeeWayApplicationIdentityNode[] = [
  ...
  },
  {
    ...
    pipeline: "POLICY",
    file: "agent-lee/voice/leeway-live-voice-manifest.json",
    runtimeRole: "Rejects non-LeeWay voice runtimes as Agent Lee's default or normal governed route.",
    verification: ["runtime-truth-live-voice-route-harness"],
    evidence: ["agent-lee/voice/leeway-live-voice-manifest.json"],
    status: "ACTIVE"
  },
  ...
  },
  {
    ...
    outputs: ["agent-lee-leeway-coding-system-<package.version>.vsix"],
  ...
  {
    id: "LEEWAY_APP::PACKAGE::RUNTIME_SEED::UPDATE_REGISTRY",
    name: "Release-safe lifecycle registry seed",
    classification: "CONFIGURATION",
    owner: "LEEWAY",
    domain: "PACKAGE",
    pipeline: "RUNTIME_SEED",
    file: "agent-lee/vscode-extension/runtime/leeway-extension-update-registry.json",
    runtimeRole: "Ships only neutral lifecycle seed values so activation recomputes active-host truth from the loaded package identity.",
    verification: ["npm run sanitize:release-state", "runtime truth hash attestation"],
    evidence: [
      "agent-lee/vscode-extension/test-evidence/leeway-release-state-sanitizer-result.json",
      "agent-lee/vscode-extension/test-evidence/runtime-truth-attestation-result.json"
    ],
    status: "ACTIVE"
  },
  {
    id: "LEEWAY_APP::PACKAGE::RELEASE::STATE_SANITIZER",
    name: "Release payload state sanitizer",
    classification: "PACKAGING",
    owner: "LEEWAY",
    domain: "PACKAGE",
    pipeline: "RELEASE",
    file: "agent-lee/vscode-extension/scripts/sanitize-release-state.mjs",
    runtimeRole: "Sanitizes lifecycle state before VSIX packaging and blocks release creation when stale packaged host truth remains.",
    verification: ["npm run sanitize:release-state"],
    evidence: ["agent-lee/vscode-extension/test-evidence/leeway-release-state-sanitizer-result.json"],
    status: "ACTIVE"
  },
  {
  ...
  },
  {
    ...
    evidence: [
      "agent-lee/governance/identity/leeway-identity-pulse.json",
      "agent-lee/vscode-extension/agent-lee-leeway-coding-system-<package.version>.vsix"
    ],
    status: "ACTIVE"
  },
  {
